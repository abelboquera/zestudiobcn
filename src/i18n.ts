export const dictionaries = {
  ...
  en: {
    ...
    nosotros: {
      ...
      davidDesc1: "With over 15 years of experience, David has produced artists such as Noan, Maren, Hey Kid, Paula Koops and Lauren Nine, composed music for League of Legends, Vèrtex (TV3) and West Side Story (the musical), and worked on recording, mixing and mastering with artists of the calibre of Iván Cornejo, Love of Lesbian, MÄLMO 040, Carla Morrison and Tommy Emmanuel, among others.",
      davidRoles: ["Guitarist", "Producer", "Composer"],
      joanTitle: "Joan Isern",
  ...
  ca: {
    ...
    nosotros: {
      ...
      davidDesc1: "Amb més de 15 anys d'experiència, ha produït artistes com Noan, Maren, Hey Kid, Paula Koops i Lauren Nine, ha compost música per a League of Legends, Vèrtex (TV3), West Side Story (el musical) i en gravació, mescla i masterització ha treballat amb artistes de la talla d'Iván Cornejo, Love of Lesbian, MÄLMO 040, Carla Morrison o Tommy Emmanuel, entre d'altres.",
      davidRoles: ["Guitarrista", "Productor", "Compositor"],
      joanTitle: "Joan Isern",
