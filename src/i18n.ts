export const dictionaries = {
  es: {
    ...
    produccion: {
      ...
      prodList: ["Pre-producción y composición", "Arreglos musicales", "Grabación de máxima calidad"],
      mixTitle: "Mezcla",
    ...
    contacto: {
      ...
      location: "Ubicación",
      locationDesc: "08024 Barcelona, España",
  ...
  en: {
    ...
    produccion: {
      ...
      prodList: ["Pre-production and songwriting", "Musical arrangements", "Top-quality recording"],
      mixTitle: "Mixing",
    ...
    contacto: {
      ...
      location: "Location",
      locationDesc: "08024 Barcelona, Spain",
  ...
  ca: {
    ...
    produccion: {
      ...
      prodList: ["Pre-producció i composició", "Arranjaments musicals", "Gravació de màxima qualitat"],
      mixTitle: "Mescla",
    ...
    contacto: {
      ...
      location: "Ubicació",
      locationDesc: "08024 Barcelona, Espanya",
